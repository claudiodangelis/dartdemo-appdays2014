...
n:function(a,b){if(b==null)return!1
return!!J.x(b).$isns&&J.de(this.Ws,b.Ws)&&J.de(this.Jz,b.Jz)&&J.de(this.wM,b.wM)},
giO:function(a){var z,y,x
z=J.c1(this.Ws,16)
y=J.c1(this.Jz,8)
x=this.wM
...
if(!!a.$isns)return["sendport",a.Ws,a.Jz,a.wM]
...
if(!!a.$isns)return new H.ns(a.Ws,a.wM,a.Jz)
throw H.b("Illegal underlying port "+H.d(a))},
...
z.xP($.xI(),$.jY())
F.kA($.mO())
y=J.Vg(document.querySelector("#takePictureBtn"))
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(new F.em(z)),y.Sg),[H.Kp(y,0)]).Zz()
y=J.Vg(document.querySelector("#restartBtn"))
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(new F.Lb()),y.Sg),[H.Kp(y,0)]).Zz()},"call$0","HA",0,0,134],
kA:[function(a){var z
H.bQ($.ZO(),new F.NY())
z=a.style
J.RE(z).sYg(z,"visible")
C.rd.suL(z,"block")},"call$1","Mk",2,0,null,135],
em:{
"^":"Tp:128;a",
call$1:[function(a){var z,y,x
...
if(z.gth()===!0){J.Ny(z,0)
J.UQ($.cM(),"navigator").K9("vibrate",[85])
...
J.UQ($.cM(),"navigator").K9("vibrate",[85])
z=this.UI
z.MA(1).ml(new F.Yc(z))},"call$1",null,2,0,null,10,"call"],
$isEH:true},
Yc:{
"^":"Tp:156;bK",
call$1:[function(a){this.bK.XE(a)},"call$1",null,2,0,null,126,"call"],
$isEH:true},
Yh:{
"^":"Tp:128;Gq",
call$1:[function(a){var z
J.UQ($.cM(),"navigator").K9("vibrate",[85])
z=this.Gq
z.MA(2).ml(new F.Su(z))},"call$1",null,2,0,null,10,"call"],
$isEH:true},
Su:{
"^":"Tp:156;Rm",
call$1:[function(a){this.Rm.XE(a)},"call$1",null,2,0,null,126,"call"],
$isEH:true},
KB:{
"^":"Tp:128;w3",
...
y.Ts(z)
y=this.w3
y.bB().ml(new F.Xv(y))},"call$1",null,2,0,null,10,"call"],
$isEH:true},
Xv:{
"^":"Tp:158;HZ",
...
J.kW(P.uw(J.UQ($.cM(),"MozActivity"),[z]),"onsuccess",new F.yX(this.HZ))},"call$1",null,2,0,null,157,"call"],
$isEH:true},
yX:{
"^":"Tp:128;mG",
call$1:[function(a){var z,y,x
...
y=J.PB(z.An,"2d")
x=J.PB(z.NU,"2d")
J.Eu(y,0,0,z.qR,z.bs)
J.Eu(x,0,0,z.UA,z.rZ)
F.kA($.kq())
x=J.PB($.Bt(),"2d")
z=J.RE(x)
z.Q4(x)
z.HT(x,150,150,100,0,6.283185307179586)
z.sWi(x,5)
z.sku(x,"#55DDCA")
z.ng(x)
z.sLm(x,"#00D2B8")
...
z.bJ(x,142,219)
z.Fp(x,250,50)
z.Ts(x)},"call$1",null,2,0,null,145,"call"],
$isEH:true},
oZ:{
"^":"Tp:128;",
call$1:[function(a){window.alert("Oops! Something went wrong trying to take a picture :-(")},"call$1",null,2,0,null,145,"call"],
$isEH:true},
Lb:{
"^":"Tp:128;",
...
return z.MM},
XE:function(a){J.cj(J.PB(this.An,"2d"),a,0,0)},
Rq:function(a,b){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j
if(b){z=this.UA
y=this.rZ
x=J.bL(J.PB(this.NU,"2d"),0,0,z,y)
w=J.Qd(x)
v=x}else{v=this.qq
w=this.qw.GM
z=this.qR
...
z=H.VM(new P.Zf(P.Dt(null)),[null])
y=this.qw
if(y.Qh===!0)this.Rq(y.pm,!0).ml(new Y.nb(this,z))
else{y=y.bv
x=z.MM
...
this.NU=b
J.vP(b,this.UA)
J.OE(this.NU,this.rZ)
this.qq=J.bL(J.PB(a,"2d"),0,0,z,y)}},
VP:{
"^":"Tp:128;a,b,c,d,e",
call$1:[function(a){var z,y,x
z=this.a
y=this.e
J.W1(J.PB(z.NU,"2d"),y,0,0)
x=this.d
x.AR=y
z.qw=x
x.bv=this.b
...
z=this.a
J.cj(J.PB(z.NU,"2d"),a,0,0)
y=J.UP(z.NU,"image/jpg")
z=window
x=y.split(",")
...
if($desc instanceof Array)$desc=$desc[1]
Ua.prototype=$desc
function ns(Ws,wM,Jz){this.Ws=Ws
this.wM=wM
...
if($desc instanceof Array)$desc=$desc[1]
KB.prototype=$desc
function Xv(HZ){this.HZ=HZ}Xv.builtin$cls="Xv"
if(!"name" in Xv)Xv.name="Xv"
$desc=$collectedClasses.Xv
if($desc instanceof Array)$desc=$desc[1]
Xv.prototype=$desc
function yX(mG){this.mG=mG}yX.builtin$cls="yX"
...
if($desc instanceof Array)$desc=$desc[1]
NY.prototype=$desc
function Vy(qw,qR,bs,UA,rZ,NU,An,qq){this.qw=qw
this.qR=qR
this.bs=bs
this.UA=UA
this.rZ=rZ
...
if($desc instanceof Array)$desc=$desc[1]
nb.prototype=$desc
function ei(bv,E5,GM,Qh,pm,AR){this.bv=bv
this.E5=E5
this.GM=GM
this.Qh=Qh
this.pm=pm
